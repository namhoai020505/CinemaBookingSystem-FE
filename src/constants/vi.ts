export const TEXT = {
  ...
  STAFF: {
    ...
    ERR_CINEMA_REQUIRED: "Vui lòng chọn chi nhánh cho tài khoản này.",
    ERR_CINEMA_NOT_ALLOWED: "Vai trò đã chọn không được gán chi nhánh.",
    ERR_CINEMA_NOT_FOUND: "Chi nhánh không tồn tại hoặc đã ngừng hoạt động. Vui lòng chọn lại.",
    ERR_ROLE_REQUIRED: "Vui lòng chọn chức vụ.",
    ERR_ROLE_NOT_ALLOWED: "Bạn không còn quyền tạo tài khoản với chức vụ đã chọn. Vui lòng tải lại trang.",
    ERR_ROLE_NOT_FOUND: "Chưa có chức vụ phù hợp để tạo tài khoản.",
    ERR_EMAIL_SEND_FAILED: "Không gửi được email mời. Vui lòng kiểm tra SMTP backend.",
    ERR_VALIDATION: "Email, họ tên hoặc thông tin nhân sự chưa hợp lệ.",
    ERR_LOAD_ROLES: "Không thể tải danh sách chức vụ.",
    ERR_LOAD_CINEMAS: "Không thể tải danh sách chi nhánh.",
    ...
    SUBTITLE: "Tạo tài khoản Staff hoặc Manager và gửi lời mời đặt mật khẩu qua email.",

    FORM_TITLE: "Tạo Tài Khoản Nhân Sự",
    LABEL_EMAIL: "Email Nhân Viên",
    PLACEHOLDER_EMAIL: "nhanvien@example.com",
    LABEL_NAME: "Họ Tên",
    ...
    NO_ASSIGNABLE_ROLES: "Chưa có chức vụ Staff hoặc Manager nào được cấp quyền tạo tài khoản.",
    BTN_SUBMITTING: "Đang tạo tài khoản...",
    BTN_SUBMIT: "Tạo Tài Khoản Và Gửi Lời Mời",

    STATUS_TITLE: "Trạng Thái",
    STATUS_SUCCESS: "Đã tạo tài khoản cho ",
    STATUS_ROLE: "Chức vụ:",
    STATUS_CINEMA: "Chi nhánh:",
    STATUS_OTP_EXPIRE: "Lời mời hết hạn lúc ",
    STATUS_LINK_LABEL: "Trang đặt mật khẩu",
    STATUS_EMPTY: "Chưa có tài khoản nhân sự nào được tạo trong phiên này.",
  },
  DASHBOARD: {
    TITLE: "Dashboard",
